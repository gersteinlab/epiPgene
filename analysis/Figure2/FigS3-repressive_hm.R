...
results <- long_data %>% na.omit() %>% filter(assay %in% c('H3K27me3', 'H3K4me1', 'H3K9me3', 'H3K36me3')) %>%
...
results$assay <- factor(results$assay, levels = c('H3K27me3', 'H3K4me1','H3K9me3', 'H3K36me3'))
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/fig2/repressive_proportion_across_tissue.pdf', p, width = 8, height = 4)
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/fig2/repressive_proportion_across_tissue_pgene.pdf', p, width = 8, height = 4)