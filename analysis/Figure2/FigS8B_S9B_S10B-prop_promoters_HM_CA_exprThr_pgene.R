...
df <- df %>% filter(str_detect(geneType, 'pseudogene'))
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/sensitivity/pgene/all_transcripts_0.1.pdf', p, width = 8, height = 4)
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/sensitivity/pgene/all_transcripts_1.pdf', p, width = 8, height = 4)
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/sensitivity/pgene/top_transcripts_0.1.pdf', p, width = 8, height = 4)
...
ggsave('/gpfs/gibbs/pi/gerstein/yj329/epiPgene/analysis/sensitivity/pgene/top_transcripts_1.pdf', p, width = 8, height = 4)